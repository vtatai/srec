...
public abstract class BaseCommand implements Command {
    ...
    protected Object findObjectSymbol(String name, ExecutionContext context) {
        ...
        if (s == null) throw new CommandExecutionException("Symbol cannot be null");
        if (!(s instanceof VarCommand)) throw new CommandExecutionException("Symbol must be a variable");
        Value value = ((VarCommand) s).getValue(null);
        if (value == null) throw new CommandExecutionException("Symbol cannot be null");
        if (value.getType() != Type.OBJECT) throw new CommandExecutionException("Symbol must refer to a Java object");
